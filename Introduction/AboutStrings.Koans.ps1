...
Describe 'Strings' {
    ...
    Context 'Evaluated Strings' {
        ...
        It 'can do a simple expansion' {
            'Your home directory is: C:\Users\Mettcon' | Should -Be "Your home directory is: $HOME"
        }
        ...
        It 'handles other ways of doing the same thing' {
            ...
            'Your home folder is: C:\Users\Mettcon' | Should -Be $String
        }
...
"@
            ...
            'I am number #2!' | Should -Be $String
        }
